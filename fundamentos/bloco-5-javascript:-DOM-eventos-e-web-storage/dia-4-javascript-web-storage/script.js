...
function changeColors() {
  ...
  if(localStorage.getItem('backgroundColor', siteColors) === 'rgb(189, 178, 255)') {
  ...
  if(localStorage.getItem('backgroundColor', siteColors) === 'rgb(155, 246, 255)') {
    document.body.style.backgroundColor = 'rgb(155, 246, 255)';
  }
  if(localStorage.getItem('backgroundColor', siteColors) === 'whitesmoke') {
